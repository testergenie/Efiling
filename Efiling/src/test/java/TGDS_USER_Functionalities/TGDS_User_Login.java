		...
		String path =null;
			...
			public void LoginPage() throws Exception {
				...
				try {	
					...
					driver.findElement(By.xpath(prop.getProperty("username"))).sendKeys("TGDSUSER1@tg.in"); 
					driver.findElement(By.xpath(prop.getProperty("password"))).sendKeys("Dev@tg123");
